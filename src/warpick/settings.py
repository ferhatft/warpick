"""
Django settings for warpick project.
...
SECRET_KEY = 'django-insecure-vsq4_)c^h9*-32v)bo6v8w9v=hnf%w#i+l^9s1*4@rdn^++1tm'
...
WSGI_APPLICATION = 'warpick.wsgi.application'
